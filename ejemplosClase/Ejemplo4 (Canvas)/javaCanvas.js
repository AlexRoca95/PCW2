...
// Dibujar el mismo cuadrado pero relleno de un color
...
// Hacer las divisiones del cuadrado en funcion del numero que indiquemos
function rejilla()
{
	let cv = document.getElementById('cv01'); 
		ctx = cv.getContext('2d'); 		
	...
	cv.width = cv.width;  		// Borra cada vez que pulsamos (redimensiona el canvas)
	ctx.beginPath(); 		
...
// Mostrar la posicion del raton en el canvas
